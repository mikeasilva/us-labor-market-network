...
# Used the classification generated by the network graph analysis
df = pd.merge(df, nodes, how='left')
df['pred'] = df['Modularity Class'].fillna(df['pred1'])
...
places.Population = pd.to_numeric(places.Population, errors='coerce')
