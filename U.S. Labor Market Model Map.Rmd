...
gg <- gg + geom_map(data=df, map=map, aes(map_id=fips, fill=Area.Name),
                    color="white", size=0.15)

gg <- gg + labs(title="U.S. Labor Markets")
gg <- gg + coord_equal()
gg <- gg + theme(legend.position="none", axis.title = element_blank(), axis.ticks = element_blank(), axis.text = element_blank())
